...
<div class="grid competencies-grid">
  <div class="grid-item">
    <div class="project-info">
      <h3><Icon name="clock" class="icon-accent" />Time Constraints</h3>
  ...
  <div class="grid-item">
    <div class="project-info">
      <h3><Icon name="bullseye" class="icon-accent" />Scope Management</h3>
  ...
  <div class="grid-item">
    <div class="project-info">
      <h3><Icon name="screwdriver-wrench" class="icon-accent" />Tool Development</h3>
